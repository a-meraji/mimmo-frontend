...
export default function Hero() {
  ...
  return (
    <section className="w-full py-20 bg-gradient-to-b from-gradient-purple via-white to-gradient-yellow-muted">
      {/* Mobile Layout */}
      <div className="container mx-auto px-6 sm:px-6 max-w-lg lg:hidden">
        <div className="flex flex-col items-center text-center pt-16">
          ...
          <h1 className="text-[2rem] leading-[1.3] font-extrabold text-text-charcoal mb-6 px-4">
            با آموزش‌های میمو با اعتماد به نفس ایتالیایی صحبت کنید !
          </h1>
          ...
          <div className="flex  gap-3 w-full mb-12">
            ...
            <Link
              href="/contact"
              className="inline-block w-full bg-white text-primary border-2 border-primary font-semibold text-base py-3.5 rounded-xl hover:bg-primary hover:text-white transition-all shadow-md"
            >
              تعیین سطح
            </Link>
          </div>
          ...
          <div className="relative w-full">
            ...
            <div 
              ...
              style={{
                background: 'linear-gradient(to bottom, #FFEAC5, #FFE6C0)',
                zIndex: 0
              }}
            />
          </div>
      ...
      <div className="hidden lg:block container mx-auto px-6 max-w-7xl pt-20">
        <div className="grid grid-cols-2 gap-12 items-stretch">
          ...
          <div className="text-right pr-12 flex flex-col justify-between">
            {/* Main Heading */}
            <h1 className="text-4xl leading-tight font-extrabold text-text-charcoal mb-6">
              با آموزش‌های میمو با اعتماد به نفس ایتالیایی صحبت کنید !
            </h1>
            ...
            <div className="flex gap-4">
              <Link
                href="/auth"
                className="inline-block bg-primary text-white font-bold text-lg px-16 py-3 rounded-xl hover:opacity-90 transition-opacity shadow-lg"
              >
                شروع آموزش
              </Link>
              <Link
                href="/contact"
                className="inline-block bg-white text-primary border-2 border-primary font-bold text-lg px-16 py-3 rounded-xl hover:bg-primary hover:text-white transition-all shadow-lg"
              >
                تعیین سطح
              </Link>
            </div>
          ...
          <div className="relative w-full">
            ...
            >
              <div className="bg-white rounded-xl shadow-2xl p-3 transform rotate-[-8deg] border-4 border-white">
                <Image
                  src="/mimmo2.webp"
                  alt="دوره آموزشی"
                  width={160}
            ...
            >
              <div className="bg-white rounded-xl shadow-2xl p-3 transform rotate-[6deg] border-4 border-white">
                <Image
                  src="/mimmo.webp"
                  alt="کلمه ANDARE"
                  width={160}
