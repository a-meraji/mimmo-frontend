...
export default function PackageCard({ package: pkg }) {
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-neutral-lighter">
      {/* Image Container */}
      <div className="relative w-full aspect-[5/4] mt-3">
        <Image
          src={pkg.image}
          alt={pkg.name}
          fill
